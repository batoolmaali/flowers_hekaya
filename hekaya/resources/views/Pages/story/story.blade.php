    ...
    <div id="app">
        ...
        @include('Layout.menu')
            <div class="levels_body" style="padding-left:2%;padding-right:2%;">
             @include('Pages.story.addstory')
            @include('Pages.story.editstory')
            <div id="grid"></div> 
        <script>
             $(function()
                {
                   ...
                   $("#grid").kendoGrid({
                       ...
                       dataSource: 
                       {
                           ...
                           transport:
                           {
                               ...
                               {
                                  dataType: "json",
                                  url: "/{{config('app.name')}}/readstory" 
                               },
                                  destroy: {
                    url:"/{{config('app.name')}}/deletestory",
                    dataType: "jsonp"
                  },
                           },
                         serverPaging: false,
                       ...
                       columns: [
                       { field: "story_name" ,title:"Story Name"},
                       { field: "statusname" ,title:"isActive"},
                       { field: "id" ,title:" ", width: "250px" , template: " <a href='level/${id}' class='k-button k-button-icontext'>Levels</a>"},
                       { field: "id" ,title:" ", width: "250px" , template: "<a class='k-button k-button-icontext' name='${id}'  onclick='popedit(this)'>Edit </a> <a class=' k-grid-delete k-button k-button-icontext' href=''>Delete</a>"},
