    ...
    <div id="app">
        ...
        <div class="levels_page">
            <div class="levelsMenu">
                ...
                <a href="admindashboard1" class="admindashboard1">
                    <img src="{{asset('assets/images/icon-home.png')}}">
                    <span>كل المشتركين</span>
                </a>
                <a href="notvoted" class="active">
             ...
             $(function()
                {
                   ...
                   $("#grid").kendoGrid({
                       ...
                       { field: "id" ,title:" " ,filterable:false,template: "<a class='k-button k-button-icontext' href='/riyal/yes/${id}'>نعم</a> <a class='k-button k-button-icontext 'title='Delete Attachment' href='/riyal/no/${id}'>لا</a>"}
