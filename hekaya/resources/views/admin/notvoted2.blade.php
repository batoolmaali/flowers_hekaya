    ...
    <div id="app">
        ...
        <div class="levels_page">
            <div class="levelsMenu">
                ...
                <a href="admindashboard2" class="active">
             ...
             $(function()
                {
                   ...
                   $("#grid").kendoGrid({
                           ...
                           e.container.find("label[for=path]").parent("div .k-edit-label").hide();
                           e.container.find("label[for=path]").parent().next("div .k-eadit-field").hide();
                           e.container.find("label[for=result1]").parent("div .k-edit-label").hide();
                           e.container.find("label[for=result1]").parent().next("div .k-eadit-field").hide();
                           e.container.find("label[for=name]").parent("div .k-edit-label").hide();
                           e.container.find("label[for=name]").parent().next("div .k-eadit-field").hide();
                              ...
                              model: 
                               {
                                   id: "id",
                                    fields: {
                                        ...
                                        points: { type: "number", validation: { required: true, min: 1,max:40} },
                                        name:{editable:false},
                                        path:{editable:false},
                                        result1:{editable:false}
                       ...
                       columns: [
                       { field: "name" ,title:"اسم المتقدم", editable:"false"},
                       ...
                       {field: "points" , title: "نتيجة المرحلة الثانية"},
                       { command: [{ name: "edit",
                  text: { edit: "قيم الآن", cancel: "إلغاء", update: "موافق" } }] }
  ],
                      editable:
                       {  mode: "inline",
                          confirmation: true,
